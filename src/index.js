...
var apiKey = "fa2484d4102e45f1a2f91d78a2284160"

fetch("https://api.rawg.io/api/games?key=" + apiKey + "&dates=2018-12-01,2022-12-19&platforms=1,7&page=1")
    .then(res => res.json())
    .then(jlista => {
        let i = 0
...
fetch("https://api.rawg.io/api/developers?key=" + apiKey + "&dates=2018-12-01,2020-11-15&platforms=1,7")
    .then(res => res.json())
    .then(plista => {
...
fetch("https://api.rawg.io/api/platforms?key=" + apiKey + "&dates=2018-12-01,2020-11-15&platforms=1,7")
    .then(res => res.json())
    .then(pplista => {
        let i = 0
...
fetch("https://api.rawg.io/api/stores?key=" + apiKey + "&dates=2018-12-01,2020-11-15&platforms=1,7")
    .then(res => res.json())
    .then(pplista => {
        let i = 0
        pplista.results.forEach(element => {
